...
public class CustomerDAOImpl implements CustomerDAO {
	...
	private static final String GET_ALL_CUSTOMER_QUERY = "select * from hr.customers";
	...
	private static final String UPDATE_CUSTOMER_QUERY = "update hr.customers set customerAddress = ?, customerName = ? ,"
